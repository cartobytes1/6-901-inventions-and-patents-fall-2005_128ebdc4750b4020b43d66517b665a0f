...
menu:
  leftnav:
    identifier: c929091c413a12f01176eb1861802dd2
    name: Projects
    weight: 50
title: Projects
type: course
uid: c929091c413a12f01176eb1861802dd2
...
| --- | --- |
| {{< td-colspan 2 >}}**I. Intellectual Property In Nanotechnology**{{< /td-colspan >}} ||
| Intellectual Property Issues Associated with the Emerging Fields of Nanotechnology ([PDF]({{< baseurl >}}/sections/projects/24501_nanotech)) | Benjamin Cooper |
| Nanobiotechnology Patents ([PDF]({{< baseurl >}}/sections/projects/24507_nanobio)) | Byron Hsu, Forrest Liau, and David Lin |
| {{< td-colspan 2 >}}**II. Software-Copyright Intellectual Property Issues**{{< /td-colspan >}} ||
| Software Intellectual Property (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/24306_software)) | Michael Matczynski and Marcos Flores |
| Copyright Infringement Due To Online File Sharing ([PDF]({{< baseurl >}}/sections/projects/online_fileshrng)) | Gabriel Alatorre, Christina Huang, and Ethan Rigel |
| Death of a Cracker - The Failure of the DMCA and How Digital Copyright Can Be Saved ([PDF]({{< baseurl >}}/sections/projects/death_cracker)) | Brian Keegan |
| Conceal or Perish? An Overview of Trade Security and the Software Industry (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/24398_conceal)) | Louise Giam and Albert Leung |
| The Software Protection Debate ([PDF]({{< baseurl >}}/sections/projects/software_protctn)) | Tri Ngo and Richard Sinn |
| Copyright Infringement in Music and an Alternative to Piracy (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/22207_music)) | John Pavlish |
| {{< td-colspan 2 >}}**III. Patent Strategies**{{< /td-colspan >}} ||
| Patent Strategies and the Progress of Science and Useful Arts ([PDF]({{< baseurl >}}/sections/projects/science_arts)) | Sebastian Buermeyer |
| Athletic Performance Enhancing Inventions; the Conflicting Interests of Inventors, Spectators, Athletes and Companies (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/22209_athlete)) | Nicholas Sidelnik |
| Improving Upon the Current Patent System ([PDF]({{< baseurl >}}/sections/projects/improving_patent)) | Cliff Roscow, Mitun Ranka, and Sedrick Tydus |
| Effects of Patent Policies on Innovation (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF - 1.2 MB]({{< baseurl >}}/sections/projects/24308_innovation)) | Raul Barreto, Julian Caballero, and Emyluz Rodriguez |
| Defending Open Science from Patent Infringement (What Does the Future Hold for University Research?) (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/24512_defending)) | Minna H. Ahn |
| Proposal for Fostering Commercialization of Patents ([PDF]({{< baseurl >}}/sections/projects/patent_cmmrclztn)) | Andrew Pinkham |
| The Difficulty of Protecting Design ([PDF]({{< baseurl >}}/sections/projects/24307_design)) | Samantha Bennett |
| {{< td-colspan 2 >}}**IV. Drug-Pharmaceutical Patents and Issues**{{< /td-colspan >}} ||
| Life Patents: The Reason, the Ramifications, the Proposed Reversal (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/24502_life)) | Anonymous |
| Prospects for Drug Accessibility and Economic Growth as Indian Pharmaceuticals Enter the Product Patent Era (![This resource may not render correctly in a screen reader.](/images/inacessible.gif)[PDF]({{< baseurl >}}/sections/projects/24392_prospect)) | Imran Hendley, Danielle Chu, Kova Jura, and Jane Yoon |
